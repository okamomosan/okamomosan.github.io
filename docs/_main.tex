...
\hypersetup{
  pdftitle={覚えよう！行動経済学の実証分析！},
  pdfauthor={Tomohisa OKADA},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{覚えよう！行動経済学の実証分析！}
...
\hypertarget{rux3068ux306f}{%
\section{Rとは？}\label{rux3068ux306f}}
...
\item
  RStudioは、Rを使うための統合開発環境（めちゃくちゃRが使いやすくなるアプリ）
\end{itemize}
...
\item
  うまくインストールできない場合は、矢内勇生先生のサイト( \url{http://yukiyanai.github.io/jp/resources/} )に詳しい解説がある
\end{itemize}
